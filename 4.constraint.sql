...
-- 제약조건 추가
alter table add constraint post_author_fk foreign key(author_id) references author(id);

-- delete, update 관련 제약조건 테스트
-- 제약조건 삭제
-- 제약조건 추가
-- on delete on cascade 테스트
...
-- default 옵션
alter table another modify column name varchar(255) default 'anonymous';
